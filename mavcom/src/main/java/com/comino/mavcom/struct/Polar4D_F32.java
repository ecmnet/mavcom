...
//	}
	...
	public void get(Vector3D_F32 t) {
		t.setTo((float) (Math.cos(angle_xy) * Math.cos(angle_xz)), (float) (Math.sin(angle_xy) * Math.cos(angle_xz)),
	...
	public void get(Vector4D_F32 t) {
		t.setTo((float) (Math.cos(angle_xy) * Math.cos(angle_xz)) * value,
				(float) (Math.sin(angle_xy) * Math.cos(angle_xz)) * value, (float) Math.sin(angle_xz) * value, yaw);
	}

	public String toString() {
		return "XY=" + MSPMathUtils.fromRad(angle_xy) + " XZ=" + MSPMathUtils.fromRad(angle_xz) + " L=" + value
				+ " Yaw=" + MSPMathUtils.fromRad(yaw);
	}
