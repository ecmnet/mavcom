 ...
 * $Date: 2013-04-12 15:21:06 +0200 (ven., 12 avr. 2013) $ 
 * 
 * ====================================================== 
...
public class MAVLinkDataType {
	...
	/**
	 * Return code in a String to read the field in byte buffer. Use different Java
	 * API if code is embedded
	 * 
	 * @param type            name
	...
	/**
	 * Return code in a String to write the field in byte buffer. Use different Java
	 * API if code is embedded
	 * 
	 * @param type            name
	 * @param forEmbeddedJava true if code must be embedded
