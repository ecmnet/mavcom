...
/**
 * Interface MAV_GENERATOR_STATUS_FLAG Flags to report status/failure cases for
 * a power generator (used in GENERATOR_STATUS). Note that FAULTS are conditions
