...
/**
 * Interface ACTUATOR_CONFIGURATION Actuator configuration, used to change a
 * setting on an actuator. Component information metadata can be used to know
 * which outputs support which commands.
 **/
public interface ACTUATOR_CONFIGURATION {
	...
	/**
	 * Permanently set the actuator (ESC) to spin direction 2 (opposite of direction
	 * 1).
	 */
