...
/**
 * Interface GIMBAL_MANAGER_CAP_FLAGS Gimbal manager high level capability flags
 * (bitmap). The first 16 bits are identical to the GIMBAL_DEVICE_CAP_FLAGS.
 * However, the gimbal manager does not need to copy the flags from the gimbal
