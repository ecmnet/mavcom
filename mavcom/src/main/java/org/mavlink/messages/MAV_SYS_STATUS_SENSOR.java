...
/**
 * Interface MAV_SYS_STATUS_SENSOR These encode the sensors whose status is sent
 * as part of the SYS_STATUS message.
 **/
public interface MAV_SYS_STATUS_SENSOR {
	...
	/**
	 * 0x80000000 Extended bit-field are used for further sensor status bits (needs
