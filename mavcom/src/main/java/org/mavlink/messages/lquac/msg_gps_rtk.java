...
/**
 * Class msg_gps_rtk RTK GPS data. Gives information on the relative baseline
...
public class msg_gps_rtk extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GPS_RTK : " + "  time_last_baseline_ms=" + time_last_baseline_ms + "  tow=" + tow
