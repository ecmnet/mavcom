...
/**
 * Class msg_named_value_int Send a key-value pair as integer. The use of this
...
public class msg_named_value_int extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_NAMED_VALUE_INT : " + "  time_boot_ms=" + time_boot_ms + "  value=" + value + "  name="
				+ getName();
	}
