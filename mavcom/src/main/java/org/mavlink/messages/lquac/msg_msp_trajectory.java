...
/**
 * Class msg_msp_trajectory MSP Trajectory factors and length
 **/
public class msg_msp_trajectory extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_TRAJECTORY : " + "  tms=" + tms + "  ls=" + format((float) ls) + "  fs="
				+ format((float) fs) + "  ax=" + format((float) ax) + "  ay=" + format((float) ay) + "  az="
				+ format((float) az) + "  bx=" + format((float) bx) + "  by=" + format((float) by) + "  bz="
				+ format((float) bz) + "  gx=" + format((float) gx) + "  gy=" + format((float) gy) + "  gz="
				+ format((float) gz) + "  sx=" + format((float) sx) + "  sy=" + format((float) sy) + "  sz="
				+ format((float) sz) + "  svx=" + format((float) svx) + "  svy=" + format((float) svy) + "  svz="
				+ format((float) svz) + "  id=" + id;
	}
