...
/**
 * Class msg_scaled_imu2 The RAW IMU readings for secondary 9DOF sensor setup.
...
public class msg_scaled_imu2 extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SCALED_IMU2 : " + "  time_boot_ms=" + time_boot_ms + "  xacc=" + xacc + "  yacc=" + yacc
