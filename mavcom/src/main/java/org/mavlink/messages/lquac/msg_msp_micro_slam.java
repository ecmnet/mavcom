...
/**
 * Class msg_msp_micro_slam MSP MICRO SLAM Data encoded in longs
 **/
public class msg_msp_micro_slam extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_MICRO_SLAM : " + "  tms=" + tms + "  px=" + format((float) px) + "  py="
				+ format((float) py) + "  pz=" + format((float) pz) + "  pd=" + format((float) pd) + "  pp="
				+ format((float) pp) + "  pv=" + format((float) pv) + "  md=" + format((float) md) + "  mw="
				+ format((float) mw) + "  dm=" + format((float) dm) + "  ox=" + format((float) ox) + "  oy="
				+ format((float) oy) + "  oz=" + format((float) oz) + "  quality=" + format((float) quality) + "  fps="
				+ format((float) fps) + "  wpcount=" + wpcount + "  flags=" + flags;
	}
