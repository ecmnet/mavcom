...
/**
 * Class msg_camera_tracking_geo_status
...
return "MAVLINK_MSG_ID_CAMERA_TRACKING_GEO_STATUS : " +   "  lat="+lat
+  "  lon="+lon
+  "  alt="+format((float)alt)
+  "  h_acc="+format((float)h_acc)
+  "  v_acc="+format((float)v_acc)
+  "  vel_n="+format((float)vel_n)
+  "  vel_e="+format((float)vel_e)
+  "  vel_d="+format((float)vel_d)
+  "  vel_acc="+format((float)vel_acc)
+  "  dist="+format((float)dist)
