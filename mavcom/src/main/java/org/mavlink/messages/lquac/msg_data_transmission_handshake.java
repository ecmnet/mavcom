...
/**
 * Class msg_data_transmission_handshake Handshake message to initiate, control
 * and stop image streaming when using the Image Transmission Protocol:
...
public class msg_data_transmission_handshake extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE : " + "  size=" + size + "  width=" + width + "  height="
				+ height + "  packets=" + packets + "  type=" + type + "  payload=" + payload + "  jpg_quality="
				+ jpg_quality;
	}
