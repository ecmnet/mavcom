...
/**
 * Class msg_hil_actuator_controls Sent from autopilot to simulation. Hardware
 * in the loop control outputs (replacement for HIL_CONTROLS)
 **/
public class msg_hil_actuator_controls extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS : " + "  time_usec=" + time_usec + "  flags=" + flags
				+ "  controls[0]=" + format((float) controls[0]) + "  controls[1]=" + format((float) controls[1])
				+ "  controls[2]=" + format((float) controls[2]) + "  controls[3]=" + format((float) controls[3])
				+ "  controls[4]=" + format((float) controls[4]) + "  controls[5]=" + format((float) controls[5])
				+ "  controls[6]=" + format((float) controls[6]) + "  controls[7]=" + format((float) controls[7])
				+ "  controls[8]=" + format((float) controls[8]) + "  controls[9]=" + format((float) controls[9])
				+ "  controls[10]=" + format((float) controls[10]) + "  controls[11]=" + format((float) controls[11])
				+ "  controls[12]=" + format((float) controls[12]) + "  controls[13]=" + format((float) controls[13])
				+ "  controls[14]=" + format((float) controls[14]) + "  controls[15]=" + format((float) controls[15])
				+ "  mode=" + mode;
	}
