...
/**
 * Class msg_set_gps_global_origin Sets the GPS co-ordinates of the vehicle
 * local origin (0,0,0) position. Vehicle should emit GPS_GLOBAL_ORIGIN
 * irrespective of whether the origin is changed. This enables transform between
 * the local coordinate frame and the global (GPS) coordinate frame, which may
 * be necessary when (for example) indoor and outdoor settings are connected and
...
public class msg_set_gps_global_origin extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SET_GPS_GLOBAL_ORIGIN : " + "  latitude=" + latitude + "  longitude=" + longitude
				+ "  altitude=" + altitude + "  target_system=" + target_system + "  time_usec=" + time_usec;
	}
