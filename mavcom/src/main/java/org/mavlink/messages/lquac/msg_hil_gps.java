...
/**
 * Class msg_hil_gps The global position, as returned by the Global Positioning
 * System (GPS). This is NOT the global position estimate of the sytem, but
 * rather a RAW sensor value. See message GLOBAL_POSITION_INT for the global
 * position estimate.
 **/
public class msg_hil_gps extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_GPS : " + "  time_usec=" + time_usec + "  lat=" + lat + "  lon=" + lon + "  alt="
				+ alt + "  eph=" + eph + "  epv=" + epv + "  vel=" + vel + "  vn=" + vn + "  ve=" + ve + "  vd=" + vd
				+ "  cog=" + cog + "  fix_type=" + fix_type + "  satellites_visible=" + satellites_visible + "  yaw="
				+ yaw + "  id=" + id;
	}
