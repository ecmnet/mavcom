...
/**
 * Class msg_attitude The attitude in the aeronautical frame (right-handed,
 * Z-down, X-front, Y-right).
 **/
public class msg_attitude extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_ATTITUDE : " + "  time_boot_ms=" + time_boot_ms + "  roll=" + format((float) roll)
