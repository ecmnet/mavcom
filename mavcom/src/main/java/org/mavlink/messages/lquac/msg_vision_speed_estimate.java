...
/**
 * Class msg_vision_speed_estimate Speed estimate from a vision source.
 **/
public class msg_vision_speed_estimate extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE : " + "  usec=" + usec + "  x=" + format((float) x) + "  y="
				+ format((float) y) + "  z=" + format((float) z) + "  covariance[0]=" + format((float) covariance[0])
				...
				+ format((float) covariance[8]) + "  reset_counter=" + reset_counter;
	}
