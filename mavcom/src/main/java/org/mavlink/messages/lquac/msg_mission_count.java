...
/**
 * Class msg_mission_count This message is emitted as response to
 * MISSION_REQUEST_LIST by the MAV and to initiate a write transaction. The GCS
 * can then request the individual mission item based on the knowledge of the
...
public class msg_mission_count extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_COUNT : " + "  count=" + count + "  target_system=" + target_system
