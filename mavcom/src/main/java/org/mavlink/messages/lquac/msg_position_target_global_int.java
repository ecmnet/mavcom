...
/**
 * Class msg_position_target_global_int Reports the current commanded vehicle
 * position, velocity, and acceleration as specified by the autopilot. This
 * should match the commands sent in SET_POSITION_TARGET_GLOBAL_INT if the
...
public class msg_position_target_global_int extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_POSITION_TARGET_GLOBAL_INT : " + "  time_boot_ms=" + time_boot_ms + "  lat_int="
				...
				+ "  yaw_rate=" + format((float) yaw_rate) + "  type_mask=" + type_mask + "  coordinate_frame="
				+ coordinate_frame;
	}
