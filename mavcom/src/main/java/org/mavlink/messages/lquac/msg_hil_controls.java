...
/**
 * Class msg_hil_controls Sent from autopilot to simulation. Hardware in the
...
public class msg_hil_controls extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_CONTROLS : " + "  time_usec=" + time_usec + "  roll_ailerons="
				+ format((float) roll_ailerons) + "  pitch_elevator=" + format((float) pitch_elevator) + "  yaw_rudder="
				+ format((float) yaw_rudder) + "  throttle=" + format((float) throttle) + "  aux1="
				+ format((float) aux1) + "  aux2=" + format((float) aux2) + "  aux3=" + format((float) aux3) + "  aux4="
				+ format((float) aux4) + "  mode=" + mode + "  nav_mode=" + nav_mode;
	}
