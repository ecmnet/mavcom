...
/**
 * Class msg_sim_state Status of simulation environment, if used
 **/
public class msg_sim_state extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SIM_STATE : " + "  q1=" + format((float) q1) + "  q2=" + format((float) q2) + "  q3="
				+ format((float) q3) + "  q4=" + format((float) q4) + "  roll=" + format((float) roll) + "  pitch="
				+ format((float) pitch) + "  yaw=" + format((float) yaw) + "  xacc=" + format((float) xacc) + "  yacc="
				+ format((float) yacc) + "  zacc=" + format((float) zacc) + "  xgyro=" + format((float) xgyro)
				+ "  ygyro=" + format((float) ygyro) + "  zgyro=" + format((float) zgyro) + "  lat="
				+ format((float) lat) + "  lon=" + format((float) lon) + "  alt=" + format((float) alt)
				+ "  std_dev_horz=" + format((float) std_dev_horz) + "  std_dev_vert=" + format((float) std_dev_vert)
				+ "  vn=" + format((float) vn) + "  ve=" + format((float) ve) + "  vd=" + format((float) vd);
	}
