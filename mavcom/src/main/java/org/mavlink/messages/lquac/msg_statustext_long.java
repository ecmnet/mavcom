...
/**
 * Class msg_statustext_long Status text message (use only for important status
 * and error messages). The full message payload can be used for status text,
 * but we recommend that updates be kept concise. Note: The message is intended
 * as a less restrictive replacement for STATUSTEXT.
 **/
public class msg_statustext_long extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_STATUSTEXT_LONG : " + "  severity=" + severity + "  text=" + getText();
	}
}
