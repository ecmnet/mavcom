...
/**
 * Class msg_uavcan_node_status General status information of an UAVCAN node.
 * Please refer to the definition of the UAVCAN message
 * "uavcan.protocol.NodeStatus" for the background information. The UAVCAN
...
public class msg_uavcan_node_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_UAVCAN_NODE_STATUS : " + "  time_usec=" + time_usec + "  uptime_sec=" + uptime_sec
				+ "  vendor_specific_status_code=" + vendor_specific_status_code + "  health=" + health + "  mode="
