...
/**
 * Class msg_wifi_config_ap Configure WiFi AP SSID, password, and mode. This
 * message is re-emitted as an acknowledgement by the AP. The message may also
...
public class msg_wifi_config_ap extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_WIFI_CONFIG_AP : " + "  ssid=" + getSsid() + "  password=" + getPassword() + "  mode="
