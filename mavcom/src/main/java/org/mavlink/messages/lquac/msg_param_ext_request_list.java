...
/**
 * Class msg_param_ext_request_list Request all parameters of this component.
 * All parameters should be emitted in response as PARAM_EXT_VALUE.
 **/
public class msg_param_ext_request_list extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST : " + "  target_system=" + target_system + "  target_component="
				+ target_component;
	}
