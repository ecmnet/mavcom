...
/**
 * Class msg_cellular_config Configure cellular modems. This message is
 * re-emitted as an acknowledgement by the modem. The message may also be
...
public class msg_cellular_config extends MAVLinkMessage {
	...
	/**
	 * Name of the cellular APN. Blank to leave it unchanged. Current APN when sent
	 * back as a response.
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_CELLULAR_CONFIG : " + "  enable_lte=" + enable_lte + "  enable_pin=" + enable_pin
				+ "  pin=" + getPin() + "  new_pin=" + getNew_pin() + "  apn=" + getApn() + "  puk=" + getPuk()
				+ "  roaming=" + roaming + "  response=" + response;
	}
