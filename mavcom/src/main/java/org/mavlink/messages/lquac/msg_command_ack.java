...
/**
 * Class msg_command_ack Report status of a command. Includes feedback whether
 * the command was executed. The command microservice is documented at
...
public class msg_command_ack extends MAVLinkMessage {
	...
	/**
	 * Also used as result_param1, it can be set with an enum containing the errors
	 * reasons of why the command was denied, or the progress percentage when result
	 * is MAV_RESULT_IN_PROGRESS (UINT8_MAX if the progress is unknown).
	 */
	public int progress;
	/**
	 * System ID of the target recipient. This is the ID of the system that sent the
	 * command for which this COMMAND_ACK is an acknowledgement.
	 */
	public int target_system;
	/**
	 * Component ID of the target recipient. This is the ID of the system that sent
	...
	public String toString() {
		return "MAVLINK_MSG_ID_COMMAND_ACK : " + "  command=" + command + "  result=" + result + "  result_param2="
				+ result_param2 + "  progress=" + progress + "  target_system=" + target_system + "  target_component="
				+ target_component;
	}
