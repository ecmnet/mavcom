...
/**
 * Class msg_rc_channels The PPM values of the RC channels received. The
 * standard PPM modulation is as follows: 1000 microseconds: 0%, 2000
 * microseconds: 100%. A value of UINT16_MAX implies the channel is unused.
...
public class msg_rc_channels extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RC_CHANNELS : " + "  time_boot_ms=" + time_boot_ms + "  chan1_raw=" + chan1_raw
				+ "  chan2_raw=" + chan2_raw + "  chan3_raw=" + chan3_raw + "  chan4_raw=" + chan4_raw + "  chan5_raw="
				+ chan5_raw + "  chan6_raw=" + chan6_raw + "  chan7_raw=" + chan7_raw + "  chan8_raw=" + chan8_raw
				+ "  chan9_raw=" + chan9_raw + "  chan10_raw=" + chan10_raw + "  chan11_raw=" + chan11_raw
				+ "  chan12_raw=" + chan12_raw + "  chan13_raw=" + chan13_raw + "  chan14_raw=" + chan14_raw
				+ "  chan15_raw=" + chan15_raw + "  chan16_raw=" + chan16_raw + "  chan17_raw=" + chan17_raw
				+ "  chan18_raw=" + chan18_raw + "  chancount=" + chancount + "  rssi=" + rssi;
	}
