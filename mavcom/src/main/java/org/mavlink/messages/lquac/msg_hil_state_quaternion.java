...
/**
 * Class msg_hil_state_quaternion Sent from simulation to autopilot, avoids in
...
public class msg_hil_state_quaternion extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_STATE_QUATERNION : " + "  time_usec=" + time_usec + "  attitude_quaternion[0]="
				+ format((float) attitude_quaternion[0]) + "  attitude_quaternion[1]="
				+ format((float) attitude_quaternion[1]) + "  attitude_quaternion[2]="
				+ format((float) attitude_quaternion[2]) + "  attitude_quaternion[3]="
				+ format((float) attitude_quaternion[3]) + "  rollspeed=" + format((float) rollspeed) + "  pitchspeed="
				+ format((float) pitchspeed) + "  yawspeed=" + format((float) yawspeed) + "  lat=" + lat + "  lon="
				+ lon + "  alt=" + alt + "  vx=" + vx + "  vy=" + vy + "  vz=" + vz + "  ind_airspeed=" + ind_airspeed
				+ "  true_airspeed=" + true_airspeed + "  xacc=" + xacc + "  yacc=" + yacc + "  zacc=" + zacc;
	}
