...
/**
 * Class msg_landing_target The location of a landing target. See:
...
public class msg_landing_target extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_LANDING_TARGET : " + "  time_usec=" + time_usec + "  angle_x=" + format((float) angle_x)
				+ "  angle_y=" + format((float) angle_y) + "  distance=" + format((float) distance) + "  size_x="
				+ format((float) size_x) + "  size_y=" + format((float) size_y) + "  target_num=" + target_num
				+ "  frame=" + frame + "  x=" + format((float) x) + "  y=" + format((float) y) + "  z="
				+ format((float) z) + "  q[0]=" + format((float) q[0]) + "  q[1]=" + format((float) q[1]) + "  q[2]="
				+ format((float) q[2]) + "  q[3]=" + format((float) q[3]) + "  type=" + type + "  position_valid="
				+ position_valid;
	}
