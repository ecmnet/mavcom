...
/**
 * Class msg_mission_request Request the information of the mission item with
 * the sequence number seq. The response of the system to this message should be
 * a MISSION_ITEM message. https://mavlink.io/en/services/mission.html
 **/
public class msg_mission_request extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_REQUEST : " + "  seq=" + seq + "  target_system=" + target_system
