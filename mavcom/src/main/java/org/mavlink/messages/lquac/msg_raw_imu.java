...
/**
 * Class msg_raw_imu The RAW IMU readings for a 9DOF sensor, which is identified
 * by the id (default IMU1). This message should always contain the true raw
...
public class msg_raw_imu extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RAW_IMU : " + "  time_usec=" + time_usec + "  xacc=" + xacc + "  yacc=" + yacc
				+ "  zacc=" + zacc + "  xgyro=" + xgyro + "  ygyro=" + ygyro + "  zgyro=" + zgyro + "  xmag=" + xmag
				+ "  ymag=" + ymag + "  zmag=" + zmag + "  temperature=" + temperature + "  id=" + id;
	}
