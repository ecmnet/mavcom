...
/**
 * Class msg_gimbal_manager_status Current status about a high level gimbal
 * manager. This message should be broadcast at a low regular rate (e.g. 5Hz).
 **/
public class msg_gimbal_manager_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GIMBAL_MANAGER_STATUS : " + "  time_boot_ms=" + time_boot_ms + "  flags=" + flags
				+ "  gimbal_device_id=" + gimbal_device_id + "  primary_control_sysid=" + primary_control_sysid
				+ "  primary_control_compid=" + primary_control_compid + "  secondary_control_sysid="
				+ secondary_control_sysid + "  secondary_control_compid=" + secondary_control_compid;
	}
