...
/**
 * Class msg_gimbal_manager_information Information about a high level gimbal
 * manager. This message should be requested by a ground station using
...
public class msg_gimbal_manager_information extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GIMBAL_MANAGER_INFORMATION : " + "  time_boot_ms=" + time_boot_ms + "  cap_flags="
				+ cap_flags + "  roll_min=" + format((float) roll_min) + "  roll_max=" + format((float) roll_max)
				+ "  pitch_min=" + format((float) pitch_min) + "  pitch_max=" + format((float) pitch_max) + "  yaw_min="
				+ format((float) yaw_min) + "  yaw_max=" + format((float) yaw_max) + "  gimbal_device_id="
				+ gimbal_device_id;
	}
