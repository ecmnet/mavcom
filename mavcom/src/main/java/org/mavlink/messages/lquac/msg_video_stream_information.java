...
/**
 * Class msg_video_stream_information Information about video stream. It may be
 * requested using MAV_CMD_REQUEST_MESSAGE, where param2 indicates the video
...
public class msg_video_stream_information extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION : " + "  framerate=" + format((float) framerate) + "  bitrate="
				+ bitrate + "  flags=" + flags + "  resolution_h=" + resolution_h + "  resolution_v=" + resolution_v
				+ "  rotation=" + rotation + "  hfov=" + hfov + "  stream_id=" + stream_id + "  count=" + count
				+ "  type=" + type + "  name=" + getName() + "  uri=" + getUri();
	}
