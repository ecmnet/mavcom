...
/**
 * Class msg_param_ext_ack Response from a PARAM_EXT_SET message.
 **/
public class msg_param_ext_ack extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_EXT_ACK : " + "  param_id=" + getParam_id() + "  param_value=" + getParam_value()
				+ "  param_type=" + param_type + "  param_result=" + param_result;
	}
