...
/**
 * Class msg_efi_status EFI status output
 **/
public class msg_efi_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_EFI_STATUS : " + "  ecu_index=" + format((float) ecu_index) + "  rpm="
				+ format((float) rpm) + "  fuel_consumed=" + format((float) fuel_consumed) + "  fuel_flow="
				+ format((float) fuel_flow) + "  engine_load=" + format((float) engine_load) + "  throttle_position="
				+ format((float) throttle_position) + "  spark_dwell_time=" + format((float) spark_dwell_time)
				+ "  barometric_pressure=" + format((float) barometric_pressure) + "  intake_manifold_pressure="
				+ format((float) intake_manifold_pressure) + "  intake_manifold_temperature="
				+ format((float) intake_manifold_temperature) + "  cylinder_head_temperature="
				+ format((float) cylinder_head_temperature) + "  ignition_timing=" + format((float) ignition_timing)
				+ "  injection_time=" + format((float) injection_time) + "  exhaust_gas_temperature="
				+ format((float) exhaust_gas_temperature) + "  throttle_out=" + format((float) throttle_out)
				+ "  pt_compensation=" + format((float) pt_compensation) + "  health=" + health;
	}
