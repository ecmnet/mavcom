...
/**
 * Class msg_debug_vect To debug something using a named 3D vector.
 **/
public class msg_debug_vect extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_DEBUG_VECT : " + "  time_usec=" + time_usec + "  x=" + format((float) x) + "  y="
				+ format((float) y) + "  z=" + format((float) z) + "  name=" + getName();
	}
