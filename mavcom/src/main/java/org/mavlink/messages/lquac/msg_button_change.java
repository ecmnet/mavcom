...
/**
 * Class msg_button_change Report button state change.
 **/
public class msg_button_change extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_BUTTON_CHANGE : " + "  time_boot_ms=" + time_boot_ms + "  last_change_ms="
				+ last_change_ms + "  state=" + state;
	}
