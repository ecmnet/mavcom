...
/**
 * Class msg_manual_control This message provides an API for manually
 * controlling the vehicle using standard joystick axes nomenclature, along with
 * a joystick-like input device. Unused axes can be disabled and buttons states
...
public class msg_manual_control extends MAVLinkMessage {
	 ...
	 * that this axis is invalid. Generally corresponds to
	 ...
	 * that this axis is invalid. Generally corresponds to a separate slider
	 * movement with maximum being 1000 and minimum being -1000 on a joystick and
	 * the thrust of a vehicle. Positive values are positive thrust, negative values
	 * are negative thrust.
	 */
	public int z;
	/**
	 * R-axis, normalized to the range [-1000,1000]. A value of INT16_MAX indicates
	 * that this axis is invalid. Generally corresponds to a twisting of the
	 * joystick, with counter-clockwise being 1000 and clockwise being -1000, and
	...
	public int target;
	/**
	 * A bitfield corresponding to the joystick buttons' 16-31 current state, 1 for
	 * pressed, 0 for released. The lowest bit corresponds to Button 16.
	 */
	public int buttons2;
	/**
	 * Pitch-only-axis, normalized to the range [-1000,1000]. Generally corresponds
	 * to pitch on vehicles with additional degrees of freedom. Valid if bit 0 of
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MANUAL_CONTROL : " + "  x=" + x + "  y=" + y + "  z=" + z + "  r=" + r + "  buttons="
				+ buttons + "  target=" + target + "  buttons2=" + buttons2 + "  s=" + s + "  t=" + t
