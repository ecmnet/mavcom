...
/**
 * Class msg_set_position_target_local_ned Sets a desired vehicle position in a
 * local north-east-down coordinate frame. Used by an external controller to
...
public class msg_set_position_target_local_ned extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED : " + "  time_boot_ms=" + time_boot_ms + "  x="
				+ format((float) x) + "  y=" + format((float) y) + "  z=" + format((float) z) + "  vx="
				+ format((float) vx) + "  vy=" + format((float) vy) + "  vz=" + format((float) vz) + "  afx="
				+ format((float) afx) + "  afy=" + format((float) afy) + "  afz=" + format((float) afz) + "  yaw="
				+ format((float) yaw) + "  yaw_rate=" + format((float) yaw_rate) + "  type_mask=" + type_mask
				+ "  target_system=" + target_system + "  target_component=" + target_component + "  coordinate_frame="
				+ coordinate_frame;
	}
