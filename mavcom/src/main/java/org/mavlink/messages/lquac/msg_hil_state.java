...
/**
 * Class msg_hil_state Sent from simulation to autopilot. This packet is useful
...
public class msg_hil_state extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_STATE : " + "  time_usec=" + time_usec + "  roll=" + format((float) roll)
				+ "  pitch=" + format((float) pitch) + "  yaw=" + format((float) yaw) + "  rollspeed="
				+ format((float) rollspeed) + "  pitchspeed=" + format((float) pitchspeed) + "  yawspeed="
				+ format((float) yawspeed) + "  lat=" + lat + "  lon=" + lon + "  alt=" + alt + "  vx=" + vx + "  vy="
				+ vy + "  vz=" + vz + "  xacc=" + xacc + "  yacc=" + yacc + "  zacc=" + zacc;
	}
