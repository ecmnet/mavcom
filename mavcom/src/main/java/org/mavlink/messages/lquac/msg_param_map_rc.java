...
/**
 * Class msg_param_map_rc Bind a RC channel to a parameter. The parameter should
 * change according to the RC channel value.
 **/
public class msg_param_map_rc extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_MAP_RC : " + "  param_value0=" + format((float) param_value0) + "  scale="
				+ format((float) scale) + "  param_value_min=" + format((float) param_value_min) + "  param_value_max="
				+ format((float) param_value_max) + "  param_index=" + param_index + "  target_system=" + target_system
				+ "  target_component=" + target_component + "  param_id=" + getParam_id()
