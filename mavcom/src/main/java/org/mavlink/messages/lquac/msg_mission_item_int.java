...
/**
 * Class msg_mission_item_int Message encoding a mission item. This message is
 ...
 * global frame is Z-up, right handed (ENU). NaN or INT32_MAX may be used in
...
public class msg_mission_item_int extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_ITEM_INT : " + "  param1=" + format((float) param1) + "  param2="
				+ format((float) param2) + "  param3=" + format((float) param3) + "  param4=" + format((float) param4)
				+ "  x=" + x + "  y=" + y + "  z=" + format((float) z) + "  seq=" + seq + "  command=" + command
				+ "  target_system=" + target_system + "  target_component=" + target_component + "  frame=" + frame
				+ "  current=" + current + "  autocontinue=" + autocontinue + "  mission_type=" + mission_type;
	}
