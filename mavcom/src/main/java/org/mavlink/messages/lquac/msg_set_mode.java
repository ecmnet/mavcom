...
/**
 * Class msg_set_mode Set the system mode, as defined by enum MAV_MODE. There is
 * no target component id as the mode is by definition for the overall aircraft,
...
public class msg_set_mode extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SET_MODE : " + "  custom_mode=" + custom_mode + "  target_system=" + target_system
				+ "  base_mode=" + base_mode;
	}
