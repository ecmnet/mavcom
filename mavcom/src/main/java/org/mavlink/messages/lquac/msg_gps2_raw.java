...
/**
 * Class msg_gps2_raw Second GPS data.
 **/
public class msg_gps2_raw extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GPS2_RAW : " + "  time_usec=" + time_usec + "  lat=" + lat + "  lon=" + lon + "  alt="
				+ alt + "  dgps_age=" + dgps_age + "  eph=" + eph + "  epv=" + epv + "  vel=" + vel + "  cog=" + cog
				+ "  fix_type=" + fix_type + "  satellites_visible=" + satellites_visible + "  dgps_numch=" + dgps_numch
				+ "  alt_ellipsoid=" + alt_ellipsoid + "  h_acc=" + h_acc + "  v_acc=" + v_acc + "  vel_acc=" + vel_acc
				+ "  hdg_acc=" + hdg_acc + "  yaw=" + yaw;
	}
