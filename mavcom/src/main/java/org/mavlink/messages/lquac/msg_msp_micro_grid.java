...
/**
 * Class msg_msp_micro_grid MSP MICRO GRID Data encoded in longs
 **/
public class msg_msp_micro_grid extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_MICRO_GRID : " + "  tms=" + tms + "  data[0]=" + data[0] + "  data[1]=" + data[1]
				...
				+ "  data[38]=" + data[38] + "  data[39]=" + data[39] + "  cx=" + format((float) cx) + "  cy="
				+ format((float) cy) + "  cz=" + format((float) cz) + "  resolution=" + format((float) resolution)
				+ "  extension=" + format((float) extension) + "  count=" + count + "  status=" + status;
	}
