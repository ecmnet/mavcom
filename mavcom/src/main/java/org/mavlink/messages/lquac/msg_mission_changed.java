...
/**
 * Class msg_mission_changed A broadcast message to notify any ground station or
 * SDK if a mission, geofence or safe points have changed on the vehicle.
 **/
public class msg_mission_changed extends MAVLinkMessage {
	 ...
	 * item (i.e. selects all items from start_index). Ignore field if
	 * start_index=-1.
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_CHANGED : " + "  start_index=" + start_index + "  end_index=" + end_index
				+ "  origin_sysid=" + origin_sysid + "  origin_compid=" + origin_compid + "  mission_type="
				+ mission_type;
	}
