...
/**
 * Class msg_param_ext_request_read Request to read the value of a parameter
 * with either the param_id string id or param_index. PARAM_EXT_VALUE should be
 * emitted in response.
 **/
public class msg_param_ext_request_read extends MAVLinkMessage {
	...
	/**
	 * Parameter index. Set to -1 to use the Parameter ID field as identifier (else
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ : " + "  param_index=" + param_index + "  target_system="
