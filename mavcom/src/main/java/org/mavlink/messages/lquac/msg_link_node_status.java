...
/**
 * Class msg_link_node_status Status generated in each node in the communication
 * chain and injected into MAVLink stream.
 **/
public class msg_link_node_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_LINK_NODE_STATUS : " + "  timestamp=" + timestamp + "  tx_rate=" + tx_rate + "  rx_rate="
				+ rx_rate + "  messages_sent=" + messages_sent + "  messages_received=" + messages_received
				+ "  messages_lost=" + messages_lost + "  rx_parse_err=" + rx_parse_err + "  tx_overflows="
				+ tx_overflows + "  rx_overflows=" + rx_overflows + "  tx_buf=" + tx_buf + "  rx_buf=" + rx_buf;
	}
