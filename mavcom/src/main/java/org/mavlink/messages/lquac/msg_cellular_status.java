...
/**
 * Class msg_cellular_status Report current used cellular network status
 **/
public class msg_cellular_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_CELLULAR_STATUS : " + "  mcc=" + mcc + "  mnc=" + mnc + "  lac=" + lac + "  status="
				+ status + "  failure_reason=" + failure_reason + "  type=" + type + "  quality=" + quality;
	}
