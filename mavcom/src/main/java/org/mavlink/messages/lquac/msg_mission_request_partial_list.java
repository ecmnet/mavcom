...
/**
 * Class msg_mission_request_partial_list Request a partial list of mission
 * items from the system/component. https://mavlink.io/en/services/mission.html.
...
public class msg_mission_request_partial_list extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST : " + "  start_index=" + start_index + "  end_index="
