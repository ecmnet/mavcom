...
/**
 * Class msg_gimbal_manager_set_pitchyaw High level message to control a
 * gimbal's pitch and yaw angles. This message is to be sent to the gimbal
 * manager (e.g. from a ground station). Angles and rates can be set to NaN
...
public class msg_gimbal_manager_set_pitchyaw extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GIMBAL_MANAGER_SET_PITCHYAW : " + "  flags=" + flags + "  pitch=" + format((float) pitch)
				+ "  yaw=" + format((float) yaw) + "  pitch_rate=" + format((float) pitch_rate) + "  yaw_rate="
				+ format((float) yaw_rate) + "  target_system=" + target_system + "  target_component="
