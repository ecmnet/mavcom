...
/**
 * Class msg_high_latency2 Message appropriate for high latency connections like
 * Iridium (version 2)
 **/
public class msg_high_latency2 extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIGH_LATENCY2 : " + "  timestamp=" + timestamp + "  latitude=" + latitude
				+ "  longitude=" + longitude + "  custom_mode=" + custom_mode + "  altitude=" + altitude
				+ "  target_altitude=" + target_altitude + "  target_distance=" + target_distance + "  wp_num=" + wp_num
				+ "  failure_flags=" + failure_flags + "  type=" + type + "  autopilot=" + autopilot + "  heading="
				+ heading + "  target_heading=" + target_heading + "  throttle=" + throttle + "  airspeed=" + airspeed
				+ "  airspeed_sp=" + airspeed_sp + "  groundspeed=" + groundspeed + "  windspeed=" + windspeed
				+ "  wind_heading=" + wind_heading + "  eph=" + eph + "  epv=" + epv + "  temperature_air="
				+ temperature_air + "  climb_rate=" + climb_rate + "  battery=" + battery + "  custom0=" + custom0
