...
/**
 * Class msg_trajectory WORK IN PROGRESS! DO NOT DEPLOY! Message to describe a
 * trajectory in the local frame. Supported trajectory types are enumerated in
...
public class msg_trajectory extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_TRAJECTORY : " + "  time_usec=" + time_usec + "  point_1=" + point_1 + "  point_2="
				+ point_2 + "  point_3=" + point_3 + "  point_4=" + point_4 + "  point_5=" + point_5 + "  type=" + type
