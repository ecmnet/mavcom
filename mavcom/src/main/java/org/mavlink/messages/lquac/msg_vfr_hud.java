...
/**
 * Class msg_vfr_hud Metrics typically displayed on a HUD for fixed wing
 * aircraft.
 **/
public class msg_vfr_hud extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_VFR_HUD : " + "  airspeed=" + format((float) airspeed) + "  groundspeed="
				+ format((float) groundspeed) + "  alt=" + format((float) alt) + "  climb=" + format((float) climb)
