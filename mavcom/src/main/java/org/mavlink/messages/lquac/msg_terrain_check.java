...
/**
 * Class msg_terrain_check Request that the vehicle report terrain height at the
 * given location (expected response is a TERRAIN_REPORT). Used by GCS to check
