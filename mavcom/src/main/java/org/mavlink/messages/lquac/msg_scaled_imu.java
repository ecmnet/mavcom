...
/**
 * Class msg_scaled_imu The RAW IMU readings for the usual 9DOF sensor setup.
...
public class msg_scaled_imu extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SCALED_IMU : " + "  time_boot_ms=" + time_boot_ms + "  xacc=" + xacc + "  yacc=" + yacc
