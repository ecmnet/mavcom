...
/**
 * Class msg_uavcan_node_info General information describing a particular UAVCAN
 * node. Please refer to the definition of the UAVCAN service
 * "uavcan.protocol.GetNodeInfo" for the background information. This message
 * should be emitted by the system whenever a new node appears online, or an
 * existing node reboots. Additionally, it can be emitted upon request from the
 * other end of the MAVLink channel (see MAV_CMD_UAVCAN_GET_NODE_INFO). It is
 * also not prohibited to emit this message unconditionally at a low frequency.
...
public class msg_uavcan_node_info extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_UAVCAN_NODE_INFO : " + "  time_usec=" + time_usec + "  uptime_sec=" + uptime_sec
				+ "  sw_vcs_commit=" + sw_vcs_commit + "  name=" + getName() + "  hw_version_major=" + hw_version_major
				+ "  hw_version_minor=" + hw_version_minor + "  hw_unique_id[0]=" + hw_unique_id[0]
				+ "  hw_unique_id[1]=" + hw_unique_id[1] + "  hw_unique_id[2]=" + hw_unique_id[2] + "  hw_unique_id[3]="
				+ hw_unique_id[3] + "  hw_unique_id[4]=" + hw_unique_id[4] + "  hw_unique_id[5]=" + hw_unique_id[5]
				+ "  hw_unique_id[6]=" + hw_unique_id[6] + "  hw_unique_id[7]=" + hw_unique_id[7] + "  hw_unique_id[8]="
				+ hw_unique_id[8] + "  hw_unique_id[9]=" + hw_unique_id[9] + "  hw_unique_id[10]=" + hw_unique_id[10]
				+ "  hw_unique_id[11]=" + hw_unique_id[11] + "  hw_unique_id[12]=" + hw_unique_id[12]
				+ "  hw_unique_id[13]=" + hw_unique_id[13] + "  hw_unique_id[14]=" + hw_unique_id[14]
				+ "  hw_unique_id[15]=" + hw_unique_id[15] + "  sw_version_major=" + sw_version_major
