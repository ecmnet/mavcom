...
/**
 * Class msg_scaled_pressure The pressure readings for the typical setup of one
 * absolute and differential pressure sensor. The units are as specified in each
 * field.
 **/
public class msg_scaled_pressure extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SCALED_PRESSURE : " + "  time_boot_ms=" + time_boot_ms + "  press_abs="
				+ format((float) press_abs) + "  press_diff=" + format((float) press_diff) + "  temperature="
				+ temperature + "  temperature_press_diff=" + temperature_press_diff;
	}
