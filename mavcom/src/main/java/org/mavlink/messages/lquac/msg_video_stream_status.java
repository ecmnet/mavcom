...
/**
 * Class msg_video_stream_status Information about the status of a video stream.
...
public class msg_video_stream_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_VIDEO_STREAM_STATUS : " + "  framerate=" + format((float) framerate) + "  bitrate="
				+ bitrate + "  flags=" + flags + "  resolution_h=" + resolution_h + "  resolution_v=" + resolution_v
				+ "  rotation=" + rotation + "  hfov=" + hfov + "  stream_id=" + stream_id;
	}
