...
/**
 * Class msg_collision Information about a potential collision
 **/
public class msg_collision extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_COLLISION : " + "  id=" + id + "  time_to_minimum_delta="
				+ format((float) time_to_minimum_delta) + "  altitude_minimum_delta="
				+ format((float) altitude_minimum_delta) + "  horizontal_minimum_delta="
				+ format((float) horizontal_minimum_delta) + "  src=" + src + "  action=" + action + "  threat_level="
				+ threat_level;
	}
