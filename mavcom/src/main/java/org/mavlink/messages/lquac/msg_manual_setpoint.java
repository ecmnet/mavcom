...
/**
 * Class msg_manual_setpoint Setpoint in roll, pitch, yaw and thrust from the
 * operator
 **/
public class msg_manual_setpoint extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MANUAL_SETPOINT : " + "  time_boot_ms=" + time_boot_ms + "  roll=" + format((float) roll)
				+ "  pitch=" + format((float) pitch) + "  yaw=" + format((float) yaw) + "  thrust="
				+ format((float) thrust) + "  mode_switch=" + mode_switch + "  manual_override_switch="
