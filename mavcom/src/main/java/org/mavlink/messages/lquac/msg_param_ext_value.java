...
/**
 * Class msg_param_ext_value Emit the value of a parameter. The inclusion of
 * param_count and param_index in the message allows the recipient to keep track
 * of received parameters and allows them to re-request missing parameters after
 * a loss or timeout.
 **/
public class msg_param_ext_value extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_EXT_VALUE : " + "  param_count=" + param_count + "  param_index=" + param_index
				+ "  param_id=" + getParam_id() + "  param_value=" + getParam_value() + "  param_type=" + param_type;
	}
