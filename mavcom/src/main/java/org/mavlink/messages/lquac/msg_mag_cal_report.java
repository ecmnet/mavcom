...
/**
 * Class msg_mag_cal_report Reports results of completed compass calibration.
...
public class msg_mag_cal_report extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MAG_CAL_REPORT : " + "  fitness=" + format((float) fitness) + "  ofs_x="
				+ format((float) ofs_x) + "  ofs_y=" + format((float) ofs_y) + "  ofs_z=" + format((float) ofs_z)
				+ "  diag_x=" + format((float) diag_x) + "  diag_y=" + format((float) diag_y) + "  diag_z="
				+ format((float) diag_z) + "  offdiag_x=" + format((float) offdiag_x) + "  offdiag_y="
				+ format((float) offdiag_y) + "  offdiag_z=" + format((float) offdiag_z) + "  compass_id=" + compass_id
				+ "  cal_mask=" + cal_mask + "  cal_status=" + cal_status + "  autosaved=" + autosaved
				+ "  orientation_confidence=" + format((float) orientation_confidence) + "  scale_factor="
				+ format((float) scale_factor) + "  old_orientation=" + old_orientation + "  new_orientation="
				+ new_orientation;
	}
