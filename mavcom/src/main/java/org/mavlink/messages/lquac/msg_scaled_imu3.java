...
/**
 * Class msg_scaled_imu3 The RAW IMU readings for 3rd 9DOF sensor setup. This
 * message should contain the scaled values to the described units
 **/
public class msg_scaled_imu3 extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SCALED_IMU3 : " + "  time_boot_ms=" + time_boot_ms + "  xacc=" + xacc + "  yacc=" + yacc
				+ "  zacc=" + zacc + "  xgyro=" + xgyro + "  ygyro=" + ygyro + "  zgyro=" + zgyro + "  xmag=" + xmag
				+ "  ymag=" + ymag + "  zmag=" + zmag + "  temperature=" + temperature;
	}
