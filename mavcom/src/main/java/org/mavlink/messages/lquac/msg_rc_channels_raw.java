...
/**
 * Class msg_rc_channels_raw The RAW values of the RC channels received. The
...
public class msg_rc_channels_raw extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RC_CHANNELS_RAW : " + "  time_boot_ms=" + time_boot_ms + "  chan1_raw=" + chan1_raw
