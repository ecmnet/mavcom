...
/**
 * Class msg_terrain_report Streamed from drone to report progress of terrain
 * map download (initiated by TERRAIN_REQUEST), or sent as a response to a
...
public class msg_terrain_report extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_TERRAIN_REPORT : " + "  lat=" + lat + "  lon=" + lon + "  terrain_height="
				+ format((float) terrain_height) + "  current_height=" + format((float) current_height) + "  spacing="
				+ spacing + "  pending=" + pending + "  loaded=" + loaded;
	}
