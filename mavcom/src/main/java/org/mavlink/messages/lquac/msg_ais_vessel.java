...
/**
 * Class msg_ais_vessel The location and information of an AIS vessel
 **/
public class msg_ais_vessel extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_AIS_VESSEL : " + "  MMSI=" + MMSI + "  lat=" + lat + "  lon=" + lon + "  COG=" + COG
				+ "  heading=" + heading + "  velocity=" + velocity + "  dimension_bow=" + dimension_bow
				+ "  dimension_stern=" + dimension_stern + "  tslc=" + tslc + "  flags=" + flags + "  turn_rate="
				+ turn_rate + "  navigational_status=" + navigational_status + "  type=" + type + "  dimension_port="
				+ dimension_port + "  dimension_starboard=" + dimension_starboard + "  callsign=" + getCallsign()
				+ "  name=" + getName();
	}
