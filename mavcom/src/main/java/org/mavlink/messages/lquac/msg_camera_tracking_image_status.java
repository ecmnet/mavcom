...
/**
 * Class msg_camera_tracking_image_status
...
return "MAVLINK_MSG_ID_CAMERA_TRACKING_IMAGE_STATUS : " +   "  point_x="+format((float)point_x)
+  "  point_y="+format((float)point_y)
+  "  radius="+format((float)radius)
+  "  rec_top_x="+format((float)rec_top_x)
+  "  rec_top_y="+format((float)rec_top_y)
+  "  rec_bottom_x="+format((float)rec_bottom_x)
+  "  rec_bottom_y="+format((float)rec_bottom_y)
