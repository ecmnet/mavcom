...
/**
 * Class msg_flight_information Information about flight since last arming.
 **/
public class msg_flight_information extends MAVLinkMessage {
	...
	/**
	 * Universally unique identifier (UUID) of flight, should correspond to name of
	 * log files
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_FLIGHT_INFORMATION : " + "  arming_time_utc=" + arming_time_utc + "  takeoff_time_utc="
				+ takeoff_time_utc + "  flight_uuid=" + flight_uuid + "  time_boot_ms=" + time_boot_ms;
	}
