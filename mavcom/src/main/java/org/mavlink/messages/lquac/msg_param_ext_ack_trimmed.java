/**
 * Generated class : msg_param_ext_ack_trimmed
 * DO NOT MODIFY!
 **/
...
/**
 * Class msg_param_ext_ack_trimmed Response from a PARAM_EXT_SET_TRIMMED
 * message.
 **/
public class msg_param_ext_ack_trimmed extends MAVLinkMessage {
	public static final int MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED = 327;
	private static final long serialVersionUID = MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED;

	public msg_param_ext_ack_trimmed() {
		this(1, 1);
	}

	public msg_param_ext_ack_trimmed(int sysId, int componentId) {
		messageType = MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED;
		this.sysId = sysId;
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED : " + "  param_result=" + param_result + "  param_type="
				+ param_type + "  param_id=" + getParam_id() + "  param_value=" + getParam_value();
	}
}
