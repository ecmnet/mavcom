...
/**
 * Class msg_estimator_innov_cov An estimator agnostic innovation covariance
 * message. Note: Very large, not meant for use over radio.
 **/
public class msg_estimator_innov_cov extends MAVLinkMessage {
	...
	/**
	 * The estimator covariance matrix (upper triangle), horizontally stacked with
	 * lengths [n, n-1, n-2, ..., 1]
	 */
	...
	/**
	 * An array describing the sensor associated with the field (see
	 * MAV_SENSOR_TYPE)
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_ESTIMATOR_INNOV_COV : " + "  time_usec=" + time_usec + "  cov=" + cov + "  n=" + n
				+ "  id=" + id + "  sensor=" + sensor;
	}
}
