...
/**
 * Class msg_log_entry Reply to LOG_REQUEST_LIST
 **/
public class msg_log_entry extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_LOG_ENTRY : " + "  time_utc=" + time_utc + "  size=" + size + "  id=" + id
				+ "  num_logs=" + num_logs + "  last_log_num=" + last_log_num;
	}
