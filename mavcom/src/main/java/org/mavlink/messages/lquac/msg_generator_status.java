...
/**
 * Class msg_generator_status Telemetry of power generation system. Alternator
 * or mechanical generator.
 **/
public class msg_generator_status extends MAVLinkMessage {
	 ...
	 * current from the generator. Positive for out. Negative for in. NaN: field not
	 * provided
	 */
	...
	/**
	 * The target battery current. Positive for out. Negative for in. NaN: field not
	 * provided
	 */
	...
	public long runtime;
	/**
	 * Seconds until this generator requires maintenance. A negative value indicates
	 * maintenance is past-due. INT32_MAX: field not provided.
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GENERATOR_STATUS : " + "  status=" + status + "  battery_current="
				+ format((float) battery_current) + "  load_current=" + format((float) load_current)
				+ "  power_generated=" + format((float) power_generated) + "  bus_voltage="
				+ format((float) bus_voltage) + "  bat_current_setpoint=" + format((float) bat_current_setpoint)
				+ "  runtime=" + runtime + "  time_until_maintenance=" + time_until_maintenance + "  generator_speed="
				+ generator_speed + "  rectifier_temperature=" + rectifier_temperature + "  generator_temperature="
