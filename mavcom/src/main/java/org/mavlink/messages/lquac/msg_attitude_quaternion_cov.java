...
/**
 * Class msg_attitude_quaternion_cov The attitude in the aeronautical frame
...
public class msg_attitude_quaternion_cov extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV : " + "  time_usec=" + time_usec + "  q[0]="
				+ format((float) q[0]) + "  q[1]=" + format((float) q[1]) + "  q[2]=" + format((float) q[2]) + "  q[3]="
				+ format((float) q[3]) + "  rollspeed=" + format((float) rollspeed) + "  pitchspeed="
				+ format((float) pitchspeed) + "  yawspeed=" + format((float) yawspeed) + "  covariance[0]="
