...
/**
 * Class msg_fence_status Status of geo-fencing. Sent in extended status stream
...
public class msg_fence_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_FENCE_STATUS : " + "  breach_time=" + breach_time + "  breach_count=" + breach_count
				+ "  breach_status=" + breach_status + "  breach_type=" + breach_type + "  breach_mitigation="
				+ breach_mitigation;
	}
