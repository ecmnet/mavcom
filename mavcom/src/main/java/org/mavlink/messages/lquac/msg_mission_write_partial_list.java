...
/**
 * Class msg_mission_write_partial_list This message is sent to the MAV to write
 * a partial list. If start index == end index, only one item will be
 * transmitted / updated. If the start index is NOT 0 and above the current list
 * size, this request should be REJECTED!
 **/
public class msg_mission_write_partial_list extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_WRITE_PARTIAL_LIST : " + "  start_index=" + start_index + "  end_index="
				+ end_index + "  target_system=" + target_system + "  target_component=" + target_component
