...
/**
 * Class msg_highres_imu The IMU readings in SI units in NED body frame
 **/
public class msg_highres_imu extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIGHRES_IMU : " + "  time_usec=" + time_usec + "  xacc=" + format((float) xacc)
				+ "  yacc=" + format((float) yacc) + "  zacc=" + format((float) zacc) + "  xgyro="
				+ format((float) xgyro) + "  ygyro=" + format((float) ygyro) + "  zgyro=" + format((float) zgyro)
				+ "  xmag=" + format((float) xmag) + "  ymag=" + format((float) ymag) + "  zmag=" + format((float) zmag)
				+ "  abs_pressure=" + format((float) abs_pressure) + "  diff_pressure=" + format((float) diff_pressure)
				+ "  pressure_alt=" + format((float) pressure_alt) + "  temperature=" + format((float) temperature)
				+ "  fields_updated=" + fields_updated + "  id=" + id;
	}
