...
/**
 * Class msg_optical_flow Optical flow from a flow sensor (e.g. optical mouse
 * sensor)
 **/
public class msg_optical_flow extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_OPTICAL_FLOW : " + "  time_usec=" + time_usec + "  flow_comp_m_x="
				+ format((float) flow_comp_m_x) + "  flow_comp_m_y=" + format((float) flow_comp_m_y)
				+ "  ground_distance=" + format((float) ground_distance) + "  flow_x=" + flow_x + "  flow_y=" + flow_y
				+ "  sensor_id=" + sensor_id + "  quality=" + quality + "  flow_rate_x=" + format((float) flow_rate_x)
