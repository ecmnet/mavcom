...
/**
 * Class msg_global_position_int The filtered global position (e.g. fused GPS
 * and accelerometers). The position is in GPS-frame (right-handed, Z-up). It is
...
public class msg_global_position_int extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GLOBAL_POSITION_INT : " + "  time_boot_ms=" + time_boot_ms + "  lat=" + lat + "  lon="
				+ lon + "  alt=" + alt + "  relative_alt=" + relative_alt + "  vx=" + vx + "  vy=" + vy + "  vz=" + vz
				+ "  hdg=" + hdg;
	}
