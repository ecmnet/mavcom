...
/**
 * Class msg_hil_optical_flow Simulated optical flow from a flow sensor (e.g.
 * PX4FLOW or optical mouse sensor)
 **/
public class msg_hil_optical_flow extends MAVLinkMessage {
	...
	/**
	 * Flow in radians around X axis (Sensor RH rotation about the X axis induces a
	 * positive flow. Sensor linear motion along the positive Y axis induces a
	 * negative flow.)
	 */
	public float integrated_x;
	/**
	 * Flow in radians around Y axis (Sensor RH rotation about the Y axis induces a
	 * positive flow. Sensor linear motion along the positive X axis induces a
	 * positive flow.)
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_OPTICAL_FLOW : " + "  time_usec=" + time_usec + "  integration_time_us="
				+ integration_time_us + "  integrated_x=" + format((float) integrated_x) + "  integrated_y="
				+ format((float) integrated_y) + "  integrated_xgyro=" + format((float) integrated_xgyro)
				+ "  integrated_ygyro=" + format((float) integrated_ygyro) + "  integrated_zgyro="
				+ format((float) integrated_zgyro) + "  time_delta_distance_us=" + time_delta_distance_us
				+ "  distance=" + format((float) distance) + "  temperature=" + temperature + "  sensor_id=" + sensor_id
				+ "  quality=" + quality;
	}
