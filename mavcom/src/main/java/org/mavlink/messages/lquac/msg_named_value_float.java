...
/**
 * Class msg_named_value_float Send a key-value pair as float. The use of this
...
public class msg_named_value_float extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_NAMED_VALUE_FLOAT : " + "  time_boot_ms=" + time_boot_ms + "  value="
				+ format((float) value) + "  name=" + getName();
	}
