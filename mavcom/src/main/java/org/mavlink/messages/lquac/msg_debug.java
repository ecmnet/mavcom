...
/**
 * Class msg_debug Send a debug value. The index is used to discriminate between
 * values. These values show up in the plot of QGroundControl as DEBUG N.
 **/
public class msg_debug extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_DEBUG : " + "  time_boot_ms=" + time_boot_ms + "  value=" + format((float) value)
				+ "  ind=" + ind;
	}
