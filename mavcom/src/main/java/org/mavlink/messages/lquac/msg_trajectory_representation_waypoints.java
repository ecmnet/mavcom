...
+  "  vel_x[0]="+format((float)vel_x[0])
+  "  vel_x[1]="+format((float)vel_x[1])
+  "  vel_x[2]="+format((float)vel_x[2])
+  "  vel_x[3]="+format((float)vel_x[3])
+  "  vel_x[4]="+format((float)vel_x[4])
+  "  vel_y[0]="+format((float)vel_y[0])
+  "  vel_y[1]="+format((float)vel_y[1])
+  "  vel_y[2]="+format((float)vel_y[2])
+  "  vel_y[3]="+format((float)vel_y[3])
+  "  vel_y[4]="+format((float)vel_y[4])
+  "  vel_z[0]="+format((float)vel_z[0])
+  "  vel_z[1]="+format((float)vel_z[1])
+  "  vel_z[2]="+format((float)vel_z[2])
+  "  vel_z[3]="+format((float)vel_z[3])
+  "  vel_z[4]="+format((float)vel_z[4])
+  "  acc_x[0]="+format((float)acc_x[0])
+  "  acc_x[1]="+format((float)acc_x[1])
+  "  acc_x[2]="+format((float)acc_x[2])
+  "  acc_x[3]="+format((float)acc_x[3])
+  "  acc_x[4]="+format((float)acc_x[4])
+  "  acc_y[0]="+format((float)acc_y[0])
+  "  acc_y[1]="+format((float)acc_y[1])
+  "  acc_y[2]="+format((float)acc_y[2])
+  "  acc_y[3]="+format((float)acc_y[3])
+  "  acc_y[4]="+format((float)acc_y[4])
+  "  acc_z[0]="+format((float)acc_z[0])
+  "  acc_z[1]="+format((float)acc_z[1])
+  "  acc_z[2]="+format((float)acc_z[2])
+  "  acc_z[3]="+format((float)acc_z[3])
+  "  acc_z[4]="+format((float)acc_z[4])
...
+  "  vel_yaw[0]="+format((float)vel_yaw[0])
+  "  vel_yaw[1]="+format((float)vel_yaw[1])
+  "  vel_yaw[2]="+format((float)vel_yaw[2])
+  "  vel_yaw[3]="+format((float)vel_yaw[3])
+  "  vel_yaw[4]="+format((float)vel_yaw[4])
+  "  command[0]="+command[0]
+  "  command[1]="+command[1]
+  "  command[2]="+command[2]
+  "  command[3]="+command[3]
