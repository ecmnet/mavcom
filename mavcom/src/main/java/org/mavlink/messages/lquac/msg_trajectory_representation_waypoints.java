...
/**
 * Class msg_trajectory_representation_waypoints Describe a trajectory using an
 * array of up-to 5 waypoints in the local frame (MAV_FRAME_LOCAL_NED).
 **/
public class msg_trajectory_representation_waypoints extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_WAYPOINTS : " + "  time_usec=" + time_usec + "  pos_x[0]="
				+ format((float) pos_x[0]) + "  pos_x[1]=" + format((float) pos_x[1]) + "  pos_x[2]="
				+ format((float) pos_x[2]) + "  pos_x[3]=" + format((float) pos_x[3]) + "  pos_x[4]="
				+ format((float) pos_x[4]) + "  pos_y[0]=" + format((float) pos_y[0]) + "  pos_y[1]="
				+ format((float) pos_y[1]) + "  pos_y[2]=" + format((float) pos_y[2]) + "  pos_y[3]="
				+ format((float) pos_y[3]) + "  pos_y[4]=" + format((float) pos_y[4]) + "  pos_z[0]="
				+ format((float) pos_z[0]) + "  pos_z[1]=" + format((float) pos_z[1]) + "  pos_z[2]="
				+ format((float) pos_z[2]) + "  pos_z[3]=" + format((float) pos_z[3]) + "  pos_z[4]="
				+ format((float) pos_z[4]) + "  vel_x[0]=" + format((float) vel_x[0]) + "  vel_x[1]="
				+ format((float) vel_x[1]) + "  vel_x[2]=" + format((float) vel_x[2]) + "  vel_x[3]="
				+ format((float) vel_x[3]) + "  vel_x[4]=" + format((float) vel_x[4]) + "  vel_y[0]="
				+ format((float) vel_y[0]) + "  vel_y[1]=" + format((float) vel_y[1]) + "  vel_y[2]="
				+ format((float) vel_y[2]) + "  vel_y[3]=" + format((float) vel_y[3]) + "  vel_y[4]="
				+ format((float) vel_y[4]) + "  vel_z[0]=" + format((float) vel_z[0]) + "  vel_z[1]="
				+ format((float) vel_z[1]) + "  vel_z[2]=" + format((float) vel_z[2]) + "  vel_z[3]="
				+ format((float) vel_z[3]) + "  vel_z[4]=" + format((float) vel_z[4]) + "  acc_x[0]="
				+ format((float) acc_x[0]) + "  acc_x[1]=" + format((float) acc_x[1]) + "  acc_x[2]="
				+ format((float) acc_x[2]) + "  acc_x[3]=" + format((float) acc_x[3]) + "  acc_x[4]="
				+ format((float) acc_x[4]) + "  acc_y[0]=" + format((float) acc_y[0]) + "  acc_y[1]="
				+ format((float) acc_y[1]) + "  acc_y[2]=" + format((float) acc_y[2]) + "  acc_y[3]="
				+ format((float) acc_y[3]) + "  acc_y[4]=" + format((float) acc_y[4]) + "  acc_z[0]="
				+ format((float) acc_z[0]) + "  acc_z[1]=" + format((float) acc_z[1]) + "  acc_z[2]="
				+ format((float) acc_z[2]) + "  acc_z[3]=" + format((float) acc_z[3]) + "  acc_z[4]="
				+ format((float) acc_z[4]) + "  pos_yaw[0]=" + format((float) pos_yaw[0]) + "  pos_yaw[1]="
				+ format((float) pos_yaw[1]) + "  pos_yaw[2]=" + format((float) pos_yaw[2]) + "  pos_yaw[3]="
				+ format((float) pos_yaw[3]) + "  pos_yaw[4]=" + format((float) pos_yaw[4]) + "  vel_yaw[0]="
				+ format((float) vel_yaw[0]) + "  vel_yaw[1]=" + format((float) vel_yaw[1]) + "  vel_yaw[2]="
				+ format((float) vel_yaw[2]) + "  vel_yaw[3]=" + format((float) vel_yaw[3]) + "  vel_yaw[4]="
				+ format((float) vel_yaw[4]) + "  command[0]=" + command[0] + "  command[1]=" + command[1]
				+ "  command[2]=" + command[2] + "  command[3]=" + command[3] + "  command[4]=" + command[4]
