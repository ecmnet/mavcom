...
/**
 * Class msg_response_event_error Response to a REQUEST_EVENT in case of an
 * error (e.g. the event is not available anymore).
 **/
public class msg_response_event_error extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RESPONSE_EVENT_ERROR : " + "  sequence=" + sequence + "  sequence_oldest_available="
				+ sequence_oldest_available + "  target_system=" + target_system + "  target_component="
				+ target_component + "  reason=" + reason;
	}
