...
/**
 * Class msg_mission_request_list Request the overall list of mission items from
...
public class msg_mission_request_list extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_REQUEST_LIST : " + "  target_system=" + target_system + "  target_component="
				+ target_component + "  mission_type=" + mission_type;
	}
