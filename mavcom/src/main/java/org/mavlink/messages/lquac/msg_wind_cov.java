...
/**
 * Class msg_wind_cov Wind covariance estimate from vehicle.
 **/
public class msg_wind_cov extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_WIND_COV : " + "  time_usec=" + time_usec + "  wind_x=" + format((float) wind_x)
				+ "  wind_y=" + format((float) wind_y) + "  wind_z=" + format((float) wind_z) + "  var_horiz="
				+ format((float) var_horiz) + "  var_vert=" + format((float) var_vert) + "  wind_alt="
				+ format((float) wind_alt) + "  horiz_accuracy=" + format((float) horiz_accuracy) + "  vert_accuracy="
				+ format((float) vert_accuracy);
	}
