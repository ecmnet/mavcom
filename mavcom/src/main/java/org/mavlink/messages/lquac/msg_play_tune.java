...
/**
 * Class msg_play_tune Control vehicle tone generation (buzzer).
 **/
public class msg_play_tune extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PLAY_TUNE : " + "  target_system=" + target_system + "  target_component="
				+ target_component + "  tune=" + getTune() + "  tune2=" + getTune2();
	}
