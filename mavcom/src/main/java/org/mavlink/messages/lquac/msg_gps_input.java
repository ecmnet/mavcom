...
/**
 * Class msg_gps_input GPS sensor input message. This is a raw sensor value sent
 * by the GPS. This is NOT the global position estimate of the system.
 **/
public class msg_gps_input extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GPS_INPUT : " + "  time_usec=" + time_usec + "  time_week_ms=" + time_week_ms + "  lat="
				+ lat + "  lon=" + lon + "  alt=" + format((float) alt) + "  hdop=" + format((float) hdop) + "  vdop="
				+ format((float) vdop) + "  vn=" + format((float) vn) + "  ve=" + format((float) ve) + "  vd="
				+ format((float) vd) + "  speed_accuracy=" + format((float) speed_accuracy) + "  horiz_accuracy="
				+ format((float) horiz_accuracy) + "  vert_accuracy=" + format((float) vert_accuracy)
				+ "  ignore_flags=" + ignore_flags + "  time_week=" + time_week + "  gps_id=" + gps_id + "  fix_type="
				+ fix_type + "  satellites_visible=" + satellites_visible + "  yaw=" + yaw;
	}
