...
/**
 * Class msg_request_data_stream Request a data stream.
 **/
public class msg_request_data_stream extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_REQUEST_DATA_STREAM : " + "  req_message_rate=" + req_message_rate + "  target_system="
				+ target_system + "  target_component=" + target_component + "  req_stream_id=" + req_stream_id
