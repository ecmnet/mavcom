...
/**
 * Class msg_param_value Emit the value of a onboard parameter. The inclusion of
 * param_count and param_index in the message allows the recipient to keep track
 * of received parameters and allows him to re-request missing parameters after
 * a loss or timeout. The parameter microservice is documented at
...
public class msg_param_value extends MAVLinkMessage {
	 ...
	 * is exactly 16 chars - applications have to provide 16+1 bytes storage if the
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_VALUE : " + "  param_value=" + format((float) param_value) + "  param_count="
				+ param_count + "  param_index=" + param_index + "  param_id=" + getParam_id() + "  param_type="
				+ param_type;
	}
