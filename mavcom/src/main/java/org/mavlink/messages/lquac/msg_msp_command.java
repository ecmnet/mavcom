...
/**
 * Class msg_msp_command MSP Commands.
 **/
public class msg_msp_command extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_COMMAND : " + "  param1=" + format((float) param1) + "  param2="
				+ format((float) param2) + "  param3=" + format((float) param3) + "  param4=" + format((float) param4)
				+ "  param5=" + format((float) param5) + "  param6=" + format((float) param6) + "  command=" + command;
	}
