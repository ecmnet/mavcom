...
/**
 * Class msg_global_vision_position_estimate Global position/attitude estimate
 * from a vision source.
 **/
public class msg_global_vision_position_estimate extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE : " + "  usec=" + usec + "  x=" + format((float) x)
				+ "  y=" + format((float) y) + "  z=" + format((float) z) + "  roll=" + format((float) roll)
				+ "  pitch=" + format((float) pitch) + "  yaw=" + format((float) yaw) + "  covariance[0]="
