...
/**
 * Class msg_log_request_list Request a list of available logs. On some systems
 * calling this may stop on-board logging until LOG_REQUEST_END is called. If
 * there are no log files available this request shall be answered with one
...
public class msg_log_request_list extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_LOG_REQUEST_LIST : " + "  start=" + start + "  end=" + end + "  target_system="
