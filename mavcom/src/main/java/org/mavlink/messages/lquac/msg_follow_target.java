...
+  "  vel[0]="+String.format("%#2.5f",(float)vel[0])
+  "  vel[1]="+String.format("%#2.5f",(float)vel[1])
+  "  vel[2]="+String.format("%#2.5f",(float)vel[2])
+  "  acc[0]="+String.format("%#2.5f",(float)acc[0])
+  "  acc[1]="+String.format("%#2.5f",(float)acc[1])
+  "  acc[2]="+String.format("%#2.5f",(float)acc[2])
+  "  attitude_q[0]="+String.format("%#2.5f",(float)attitude_q[0])
+  "  attitude_q[1]="+String.format("%#2.5f",(float)attitude_q[1])
+  "  attitude_q[2]="+String.format("%#2.5f",(float)attitude_q[2])
+  "  attitude_q[3]="+String.format("%#2.5f",(float)attitude_q[3])
+  "  rates[0]="+String.format("%#2.5f",(float)rates[0])
+  "  rates[1]="+String.format("%#2.5f",(float)rates[1])
+  "  rates[2]="+String.format("%#2.5f",(float)rates[2])
+  "  position_cov[0]="+String.format("%#2.5f",(float)position_cov[0])
+  "  position_cov[1]="+String.format("%#2.5f",(float)position_cov[1])
+  "  position_cov[2]="+String.format("%#2.5f",(float)position_cov[2])
