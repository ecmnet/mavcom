...
/**
 * Class msg_raw_pressure The RAW pressure readings for the typical setup of one
 * absolute pressure and one differential pressure sensor. The sensor values
...
public class msg_raw_pressure extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RAW_PRESSURE : " + "  time_usec=" + time_usec + "  press_abs=" + press_abs
				+ "  press_diff1=" + press_diff1 + "  press_diff2=" + press_diff2 + "  temperature=" + temperature;
	}
