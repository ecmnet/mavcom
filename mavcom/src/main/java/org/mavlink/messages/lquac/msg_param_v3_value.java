/**
 * Generated class : msg_param_v3_value
 * DO NOT MODIFY!
 **/
...
/**
 * Class msg_param_v3_value Emit the value of a parameter. The param_count and
 * param_index fields allow the recipient to keep track of received parameters
 * and to re-request missing parameters after a loss or timeout. Replacement for
 * PARAM_EXT_VALUE.
 **/
public class msg_param_v3_value extends MAVLinkMessage {
	public static final int MAVLINK_MSG_ID_PARAM_V3_VALUE = 325;
	private static final long serialVersionUID = MAVLINK_MSG_ID_PARAM_V3_VALUE;

	public msg_param_v3_value() {
		this(1, 1);
	}

	public msg_param_v3_value(int sysId, int componentId) {
		messageType = MAVLINK_MSG_ID_PARAM_V3_VALUE;
		this.sysId = sysId;
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PARAM_V3_VALUE : " + "  param_count=" + param_count + "  param_index=" + param_index
				+ "  param_id=" + getParam_id() + "  param_type=" + param_type + "  param_value=" + getParam_value();
	}
}
