...
/**
 * Class msg_gps_global_origin Publishes the GPS co-ordinates of the vehicle
 * local origin (0,0,0) position. Emitted whenever a new GPS-Local position
 * mapping is requested or set - e.g. following SET_GPS_GLOBAL_ORIGIN message.
 **/
public class msg_gps_global_origin extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN : " + "  latitude=" + latitude + "  longitude=" + longitude
				+ "  altitude=" + altitude + "  time_usec=" + time_usec;
	}
