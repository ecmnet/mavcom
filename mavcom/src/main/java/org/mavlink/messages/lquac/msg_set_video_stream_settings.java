...
/**
 * Class msg_set_video_stream_settings Message that sets video stream settings
 **/
public class msg_set_video_stream_settings extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SET_VIDEO_STREAM_SETTINGS : " + "  framerate=" + framerate + "  bitrate=" + bitrate
				+ "  resolution_h=" + resolution_h + "  resolution_v=" + resolution_v + "  rotation=" + rotation
				+ "  target_system=" + target_system + "  target_component=" + target_component + "  camera_id="
				+ camera_id + "  uri=" + getUri();
	}
}
