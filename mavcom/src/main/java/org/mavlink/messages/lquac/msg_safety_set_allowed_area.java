...
return "MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA : " +   "  p1x="+format((float)p1x)
+  "  p1y="+format((float)p1y)
+  "  p1z="+format((float)p1z)
+  "  p2x="+format((float)p2x)
+  "  p2y="+format((float)p2y)
+  "  p2z="+format((float)p2z)
