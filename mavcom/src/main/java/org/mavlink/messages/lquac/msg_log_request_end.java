...
/**
 * Class msg_log_request_end Stop log transfer and resume normal logging
 **/
public class msg_log_request_end extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_LOG_REQUEST_END : " + "  target_system=" + target_system + "  target_component="
				+ target_component;
	}
