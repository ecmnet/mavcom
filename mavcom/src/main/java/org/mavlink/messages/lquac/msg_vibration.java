...
/**
 * Class msg_vibration Vibration levels and accelerometer clipping
 **/
public class msg_vibration extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_VIBRATION : " + "  time_usec=" + time_usec + "  vibration_x="
				+ format((float) vibration_x) + "  vibration_y=" + format((float) vibration_y) + "  vibration_z="
				+ format((float) vibration_z) + "  clipping_0=" + clipping_0 + "  clipping_1=" + clipping_1
