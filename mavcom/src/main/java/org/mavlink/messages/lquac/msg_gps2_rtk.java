...
/**
 * Class msg_gps2_rtk RTK GPS data. Gives information on the relative baseline
...
public class msg_gps2_rtk extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GPS2_RTK : " + "  time_last_baseline_ms=" + time_last_baseline_ms + "  tow=" + tow
				+ "  baseline_a_mm=" + baseline_a_mm + "  baseline_b_mm=" + baseline_b_mm + "  baseline_c_mm="
				+ baseline_c_mm + "  accuracy=" + accuracy + "  iar_num_hypotheses=" + iar_num_hypotheses + "  wn=" + wn
				+ "  rtk_receiver_id=" + rtk_receiver_id + "  rtk_health=" + rtk_health + "  rtk_rate=" + rtk_rate
				+ "  nsats=" + nsats + "  baseline_coords_type=" + baseline_coords_type;
	}
