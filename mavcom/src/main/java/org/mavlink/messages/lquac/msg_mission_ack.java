...
/**
 * Class msg_mission_ack Acknowledgment message during waypoint handling. The
 * type field states if this message is a positive ack (type=0) or if an error
...
public class msg_mission_ack extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_ACK : " + "  target_system=" + target_system + "  target_component="
				+ target_component + "  type=" + type + "  mission_type=" + mission_type;
	}
