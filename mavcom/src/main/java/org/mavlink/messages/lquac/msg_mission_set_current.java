...
/**
 * Class msg_mission_set_current Set the mission item with sequence number seq
 * as current item. This means that the MAV will continue to this mission item
 * on the shortest path (not following the mission items in-between).
 **/
public class msg_mission_set_current extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_SET_CURRENT : " + "  seq=" + seq + "  target_system=" + target_system
