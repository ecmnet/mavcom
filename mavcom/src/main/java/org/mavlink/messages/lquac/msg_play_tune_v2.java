...
/**
 * Class msg_play_tune_v2 Play vehicle tone/tune (buzzer). Supersedes message
 * PLAY_TUNE.
 **/
public class msg_play_tune_v2 extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PLAY_TUNE_V2 : " + "  format=" + format + "  target_system=" + target_system
				+ "  target_component=" + target_component + "  tune=" + getTune();
	}
