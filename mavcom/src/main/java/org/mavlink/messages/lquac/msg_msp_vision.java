...
/**
 * Class msg_msp_vision MSP Vision
 **/
public class msg_msp_vision extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_VISION : " + "  tms=" + tms + "  x=" + format((float) x) + "  y=" + format((float) y)
				+ "  z=" + format((float) z) + "  vx=" + format((float) vx) + "  vy=" + format((float) vy) + "  vz="
				+ format((float) vz) + "  h=" + format((float) h) + "  p=" + format((float) p) + "  r="
				+ format((float) r) + "  gx=" + format((float) gx) + "  gy=" + format((float) gy) + "  gz="
				+ format((float) gz) + "  px=" + format((float) px) + "  py=" + format((float) py) + "  pz="
				+ format((float) pz) + "  pw=" + format((float) pw) + "  fps=" + format((float) fps) + "  flags="
				+ flags + "  errors=" + errors + "  quality=" + quality;
	}
