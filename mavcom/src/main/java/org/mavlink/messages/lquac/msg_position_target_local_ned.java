...
/**
 * Class msg_position_target_local_ned Reports the current commanded vehicle
 * position, velocity, and acceleration as specified by the autopilot. This
 * should match the commands sent in SET_POSITION_TARGET_LOCAL_NED if the
...
public class msg_position_target_local_ned extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED : " + "  time_boot_ms=" + time_boot_ms + "  x="
