...
/**
 * Class msg_smart_battery_status Smart Battery information (dynamic). Use for
 * updates from: smart battery to flight stack, flight stack to GCS. Use instead
...
public class msg_smart_battery_status extends MAVLinkMessage {
	...
	/**
	 * Battery current (through all cells/loads). Positive if discharging, negative
	 * if charging. UINT16_MAX: field not provided.
	 */
	public int current;
	/**
	...
	/**
	 * The cell number of the first index in the 'voltages' array field. Using this
	 * field allows you to specify cell voltages for batteries with more than 16
	 * cells.
	 */
	public int cell_offset;
	/**
	 * Individual cell voltages. Batteries with more 16 cells can use the
	 * cell_offset field to specify the cell offset for the array specified in the
	 * current message . Index values above the valid cell count for this battery
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SMART_BATTERY_STATUS : " + "  fault_bitmask=" + fault_bitmask + "  time_remaining="
				+ time_remaining + "  id=" + id + "  capacity_remaining=" + capacity_remaining + "  current=" + current
				+ "  temperature=" + temperature + "  cell_offset=" + cell_offset + "  voltages[0]=" + voltages[0]
				+ "  voltages[1]=" + voltages[1] + "  voltages[2]=" + voltages[2] + "  voltages[3]=" + voltages[3]
				+ "  voltages[4]=" + voltages[4] + "  voltages[5]=" + voltages[5] + "  voltages[6]=" + voltages[6]
				+ "  voltages[7]=" + voltages[7] + "  voltages[8]=" + voltages[8] + "  voltages[9]=" + voltages[9]
				+ "  voltages[10]=" + voltages[10] + "  voltages[11]=" + voltages[11] + "  voltages[12]=" + voltages[12]
				+ "  voltages[13]=" + voltages[13] + "  voltages[14]=" + voltages[14] + "  voltages[15]="
				+ voltages[15];
	}
}
