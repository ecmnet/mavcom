...
/**
 * Class msg_heartbeat The heartbeat message shows that a system or component is
 * present and responding. The type and autopilot fields (along with the message
 * component id), allow the receiving system to treat further messages from this
 * system appropriately (e.g. by laying out the user interface based on the
 * autopilot). This microservice is documented at
...
public class msg_heartbeat extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HEARTBEAT : " + "  custom_mode=" + custom_mode + "  type=" + type + "  autopilot="
				+ autopilot + "  base_mode=" + base_mode + "  system_status=" + system_status + "  mavlink_version="
				+ mavlink_version;
	}
