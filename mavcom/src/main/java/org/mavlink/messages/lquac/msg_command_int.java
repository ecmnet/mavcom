...
/**
 * Class msg_command_int Message encoding a command with parameters as scaled
 * integers. Scaling depends on the actual command value. NaN or INT32_MAX may
 * be used in float/integer params (respectively) to indicate optional/default
 * values (e.g. to use the component's current latitude, yaw rather than a
...
public class msg_command_int extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_COMMAND_INT : " + "  param1=" + format((float) param1) + "  param2="
				+ format((float) param2) + "  param3=" + format((float) param3) + "  param4=" + format((float) param4)
				+ "  x=" + x + "  y=" + y + "  z=" + format((float) z) + "  command=" + command + "  target_system="
				+ target_system + "  target_component=" + target_component + "  frame=" + frame + "  current=" + current
