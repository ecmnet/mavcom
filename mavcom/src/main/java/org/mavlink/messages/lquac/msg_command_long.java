...
/**
 * Class msg_command_long Send a command with up to seven parameters to the MAV.
...
public class msg_command_long extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_COMMAND_LONG : " + "  param1=" + format((float) param1) + "  param2="
				+ format((float) param2) + "  param3=" + format((float) param3) + "  param4=" + format((float) param4)
				+ "  param5=" + format((float) param5) + "  param6=" + format((float) param6) + "  param7="
				+ format((float) param7) + "  command=" + command + "  target_system=" + target_system
