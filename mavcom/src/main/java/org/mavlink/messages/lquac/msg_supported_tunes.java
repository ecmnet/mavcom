...
/**
 * Class msg_supported_tunes Tune formats supported by vehicle. This should be
...
public class msg_supported_tunes extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SUPPORTED_TUNES : " + "  format=" + format + "  target_system=" + target_system
