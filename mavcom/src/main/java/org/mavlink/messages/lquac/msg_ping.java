...
/**
 * Class msg_ping A ping message either requesting or responding to a ping. This
 * allows to measure the system latencies, including serial port, radio modem
...
public class msg_ping extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_PING : " + "  time_usec=" + time_usec + "  seq=" + seq + "  target_system="
