...
/**
 * Class msg_hil_rc_inputs_raw Sent from simulation to autopilot. The RAW values
 * of the RC channels received. The standard PPM modulation is as follows: 1000
...
public class msg_hil_rc_inputs_raw extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW : " + "  time_usec=" + time_usec + "  chan1_raw=" + chan1_raw
				...
				+ "  chan12_raw=" + chan12_raw + "  rssi=" + rssi;
	}
