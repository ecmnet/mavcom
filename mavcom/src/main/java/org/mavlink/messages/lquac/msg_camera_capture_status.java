...
/**
 * Class msg_camera_capture_status Information about the status of a capture.
...
public class msg_camera_capture_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS : " + "  time_boot_ms=" + time_boot_ms + "  image_interval="
				+ format((float) image_interval) + "  recording_time_ms=" + recording_time_ms + "  available_capacity="
				+ format((float) available_capacity) + "  image_status=" + image_status + "  video_status="
				+ video_status + "  image_count=" + image_count;
	}
