...
/**
 * Class msg_rc_channels_scaled The scaled values of the RC channels received:
 * (-100%) -10000, (0%) 0, (100%) 10000. Channels that are inactive should be
 * set to UINT16_MAX.
 **/
public class msg_rc_channels_scaled extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_RC_CHANNELS_SCALED : " + "  time_boot_ms=" + time_boot_ms + "  chan1_scaled="
				+ chan1_scaled + "  chan2_scaled=" + chan2_scaled + "  chan3_scaled=" + chan3_scaled + "  chan4_scaled="
				+ chan4_scaled + "  chan5_scaled=" + chan5_scaled + "  chan6_scaled=" + chan6_scaled + "  chan7_scaled="
				+ chan7_scaled + "  chan8_scaled=" + chan8_scaled + "  port=" + port + "  rssi=" + rssi;
	}
