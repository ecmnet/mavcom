...
/**
 * Class msg_distance_sensor Distance sensor information for an onboard
 * rangefinder.
 **/
public class msg_distance_sensor extends MAVLinkMessage {
	 ...
	 * This field is required if the orientation is set to
	...
	public String toString() {
		return "MAVLINK_MSG_ID_DISTANCE_SENSOR : " + "  time_boot_ms=" + time_boot_ms + "  min_distance=" + min_distance
				+ "  max_distance=" + max_distance + "  current_distance=" + current_distance + "  type=" + type
				+ "  id=" + id + "  orientation=" + orientation + "  covariance=" + covariance + "  horizontal_fov="
				+ format((float) horizontal_fov) + "  vertical_fov=" + format((float) vertical_fov) + "  quaternion[0]="
				+ format((float) quaternion[0]) + "  quaternion[1]=" + format((float) quaternion[1])
				+ "  quaternion[2]=" + format((float) quaternion[2]) + "  quaternion[3]="
				+ format((float) quaternion[3]) + "  signal_quality=" + signal_quality;
	}
