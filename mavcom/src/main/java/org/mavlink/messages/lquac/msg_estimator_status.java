...
+  "  vel_ratio="+format((float)vel_ratio)
+  "  pos_horiz_ratio="+format((float)pos_horiz_ratio)
+  "  pos_vert_ratio="+format((float)pos_vert_ratio)
+  "  mag_ratio="+format((float)mag_ratio)
+  "  hagl_ratio="+format((float)hagl_ratio)
+  "  tas_ratio="+format((float)tas_ratio)
+  "  pos_horiz_accuracy="+format((float)pos_horiz_accuracy)
+  "  pos_vert_accuracy="+format((float)pos_vert_accuracy)
+  "  flags="+flags
;}
