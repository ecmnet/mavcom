...
/**
 * Class msg_onboard_computer_status Hardware status sent by an onboard
 * computer.
 **/
public class msg_onboard_computer_status extends MAVLinkMessage {
	...
	public long uptime;
	/**
	 * Amount of used RAM on the component system. A value of UINT32_MAX implies the
	 * field is unused.
	 */
	...
	/**
	 * Storage type: 0: HDD, 1: SSD, 2: EMMC, 3: SD card (non-removable), 4: SD card
	...
	/**
	 * Total amount of storage space on the component system. A value of UINT32_MAX
	 * implies the field is unused.
	 */
	...
	/**
	 * Network traffic from the component system. A value of UINT32_MAX implies the
	 * field is unused.
	 */
	...
	/**
	 * Network capacity from the component system. A value of UINT32_MAX implies the
	 * field is unused.
	 */
	...
	/**
	 * Combined CPU usage as the last 10 slices of 100 MS (a histogram). This allows
	 * to identify spikes in load that max out the system, but only for a short
	 * amount of time. A value of UINT8_MAX implies the field is unused.
	 */
	...
	/**
	 * Combined GPU usage as the last 10 slices of 100 MS (a histogram). This allows
	 * to identify spikes in load that max out the system, but only for a short
	 * amount of time. A value of UINT8_MAX implies the field is unused.
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_ONBOARD_COMPUTER_STATUS : " + "  time_usec=" + time_usec + "  uptime=" + uptime
				+ "  ram_usage=" + ram_usage + "  ram_total=" + ram_total + "  storage_type[0]=" + storage_type[0]
				+ "  storage_type[1]=" + storage_type[1] + "  storage_type[2]=" + storage_type[2] + "  storage_type[3]="
				+ storage_type[3] + "  storage_usage[0]=" + storage_usage[0] + "  storage_usage[1]=" + storage_usage[1]
				+ "  storage_usage[2]=" + storage_usage[2] + "  storage_usage[3]=" + storage_usage[3]
				+ "  storage_total[0]=" + storage_total[0] + "  storage_total[1]=" + storage_total[1]
				+ "  storage_total[2]=" + storage_total[2] + "  storage_total[3]=" + storage_total[3]
				+ "  link_type[0]=" + link_type[0] + "  link_type[1]=" + link_type[1] + "  link_type[2]=" + link_type[2]
				+ "  link_type[3]=" + link_type[3] + "  link_type[4]=" + link_type[4] + "  link_type[5]=" + link_type[5]
				+ "  link_tx_rate[0]=" + link_tx_rate[0] + "  link_tx_rate[1]=" + link_tx_rate[1] + "  link_tx_rate[2]="
				+ link_tx_rate[2] + "  link_tx_rate[3]=" + link_tx_rate[3] + "  link_tx_rate[4]=" + link_tx_rate[4]
				+ "  link_tx_rate[5]=" + link_tx_rate[5] + "  link_rx_rate[0]=" + link_rx_rate[0] + "  link_rx_rate[1]="
				+ link_rx_rate[1] + "  link_rx_rate[2]=" + link_rx_rate[2] + "  link_rx_rate[3]=" + link_rx_rate[3]
				+ "  link_rx_rate[4]=" + link_rx_rate[4] + "  link_rx_rate[5]=" + link_rx_rate[5] + "  link_tx_max[0]="
				+ link_tx_max[0] + "  link_tx_max[1]=" + link_tx_max[1] + "  link_tx_max[2]=" + link_tx_max[2]
				+ "  link_tx_max[3]=" + link_tx_max[3] + "  link_tx_max[4]=" + link_tx_max[4] + "  link_tx_max[5]="
				+ link_tx_max[5] + "  link_rx_max[0]=" + link_rx_max[0] + "  link_rx_max[1]=" + link_rx_max[1]
				+ "  link_rx_max[2]=" + link_rx_max[2] + "  link_rx_max[3]=" + link_rx_max[3] + "  link_rx_max[4]="
				+ link_rx_max[4] + "  link_rx_max[5]=" + link_rx_max[5] + "  fan_speed[0]=" + fan_speed[0]
				+ "  fan_speed[1]=" + fan_speed[1] + "  fan_speed[2]=" + fan_speed[2] + "  fan_speed[3]=" + fan_speed[3]
				+ "  type=" + type + "  cpu_cores[0]=" + cpu_cores[0] + "  cpu_cores[1]=" + cpu_cores[1]
				+ "  cpu_cores[2]=" + cpu_cores[2] + "  cpu_cores[3]=" + cpu_cores[3] + "  cpu_cores[4]=" + cpu_cores[4]
				+ "  cpu_cores[5]=" + cpu_cores[5] + "  cpu_cores[6]=" + cpu_cores[6] + "  cpu_cores[7]=" + cpu_cores[7]
				+ "  cpu_combined[0]=" + cpu_combined[0] + "  cpu_combined[1]=" + cpu_combined[1] + "  cpu_combined[2]="
				+ cpu_combined[2] + "  cpu_combined[3]=" + cpu_combined[3] + "  cpu_combined[4]=" + cpu_combined[4]
				+ "  cpu_combined[5]=" + cpu_combined[5] + "  cpu_combined[6]=" + cpu_combined[6] + "  cpu_combined[7]="
				+ cpu_combined[7] + "  cpu_combined[8]=" + cpu_combined[8] + "  cpu_combined[9]=" + cpu_combined[9]
				+ "  gpu_cores[0]=" + gpu_cores[0] + "  gpu_cores[1]=" + gpu_cores[1] + "  gpu_cores[2]=" + gpu_cores[2]
				+ "  gpu_cores[3]=" + gpu_cores[3] + "  gpu_combined[0]=" + gpu_combined[0] + "  gpu_combined[1]="
				+ gpu_combined[1] + "  gpu_combined[2]=" + gpu_combined[2] + "  gpu_combined[3]=" + gpu_combined[3]
				+ "  gpu_combined[4]=" + gpu_combined[4] + "  gpu_combined[5]=" + gpu_combined[5] + "  gpu_combined[6]="
				+ gpu_combined[6] + "  gpu_combined[7]=" + gpu_combined[7] + "  gpu_combined[8]=" + gpu_combined[8]
				+ "  gpu_combined[9]=" + gpu_combined[9] + "  temperature_board=" + temperature_board
				+ "  temperature_core[0]=" + temperature_core[0] + "  temperature_core[1]=" + temperature_core[1]
				+ "  temperature_core[2]=" + temperature_core[2] + "  temperature_core[3]=" + temperature_core[3]
				+ "  temperature_core[4]=" + temperature_core[4] + "  temperature_core[5]=" + temperature_core[5]
				+ "  temperature_core[6]=" + temperature_core[6] + "  temperature_core[7]=" + temperature_core[7];
	}
