...
/**
 * Class msg_msp_status MSP Status message.
 **/
public class msg_msp_status extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MSP_STATUS : " + "  uptime_ms=" + uptime_ms + "  unix_time_us=" + unix_time_us
				+ "  com_error=" + com_error + "  status=" + status + "  autopilot_mode=" + autopilot_mode
				+ "  takeoff_ms=" + takeoff_ms + "  load=" + load + "  memory=" + memory + "  threads=" + threads
				+ "  wifi_quality=" + wifi_quality + "  cpu_temp=" + cpu_temp + "  bat_temp=" + bat_temp + "  version="
				+ getVersion() + "  arch=" + getArch();
	}
