...
/**
 * Class msg_gimbal_manager_set_attitude High level message to control a
 * gimbal's attitude. This message is to be sent to the gimbal manager (e.g.
 * from a ground station). Angles and rates can be set to NaN according to use
 * case.
 **/
public class msg_gimbal_manager_set_attitude extends MAVLinkMessage {
	 ...
	 * depends on whether the flag GIMBAL_MANAGER_FLAGS_YAW_LOCK is set)
	 */
	...
	public String toString() {
		return "MAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE : " + "  flags=" + flags + "  q[0]=" + format((float) q[0])
				...
				+ "  target_system=" + target_system + "  target_component=" + target_component + "  gimbal_device_id="
				+ gimbal_device_id;
	}
