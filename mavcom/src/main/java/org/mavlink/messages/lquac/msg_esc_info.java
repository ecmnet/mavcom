...
/**
 * Class msg_esc_info ESC information for lower rate streaming. Recommended
...
public class msg_esc_info extends MAVLinkMessage {
	...
	public String toString() {
		return "MAVLINK_MSG_ID_ESC_INFO : " + "  time_usec=" + time_usec + "  error_count[0]=" + error_count[0]
				+ "  error_count[1]=" + error_count[1] + "  error_count[2]=" + error_count[2] + "  error_count[3]="
				+ error_count[3] + "  counter=" + counter + "  failure_flags[0]=" + failure_flags[0]
				+ "  failure_flags[1]=" + failure_flags[1] + "  failure_flags[2]=" + failure_flags[2]
				+ "  failure_flags[3]=" + failure_flags[3] + "  temperature[0]=" + temperature[0] + "  temperature[1]="
				+ temperature[1] + "  temperature[2]=" + temperature[2] + "  temperature[3]=" + temperature[3]
				+ "  index=" + index + "  count=" + count + "  connection_type=" + connection_type + "  info=" + info;
	}
