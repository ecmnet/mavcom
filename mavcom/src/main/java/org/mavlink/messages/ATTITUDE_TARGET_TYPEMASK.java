...
/**
 * Interface ATTITUDE_TARGET_TYPEMASK Bitmap to indicate which dimensions should
 * be ignored by the vehicle: a value of 0b00000000 indicates that none of the
 * setpoint dimensions should be ignored.
 **/
