...
/**
 * Interface MAV_SEVERITY Indicates the severity level, generally used for
 * status messages to indicate their relative urgency. Based on RFC-5424 using
 * expanded definitions at:
