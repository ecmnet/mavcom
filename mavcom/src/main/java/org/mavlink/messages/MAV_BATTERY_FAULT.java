...
/**
 * Interface MAV_BATTERY_FAULT Smart battery supply status/fault flags (bitmask)
 * for health indication. The battery must also report either
...
public interface MAV_BATTERY_FAULT {
	...
	/**
	 * Vehicle voltage is not compatible with this battery (batteries on same power
