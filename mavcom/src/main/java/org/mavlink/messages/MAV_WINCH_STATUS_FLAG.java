...
/**
 * Interface MAV_WINCH_STATUS_FLAG Winch status flags used in WINCH_STATUS
 **/
public interface MAV_WINCH_STATUS_FLAG {
	...
	/**
	 * Winch is abandoning the line and possibly payload. Winch unspools the entire
	 * calculated line length. This is a failover state from REDELIVER if the number
