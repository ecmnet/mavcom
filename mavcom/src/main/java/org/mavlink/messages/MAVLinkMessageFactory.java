...
public static MAVLinkMessage getMessage(int msgid, int sysId, int componentId, byte[] rawData) throws IOException {
  ...
  case MAVLINK_MSG_ID_CAMERA_TRACKING_GEO_STATUS:
      msg = new msg_camera_tracking_geo_status(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_CAMERA_TRACKING_IMAGE_STATUS:
      msg = new msg_camera_tracking_image_status(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_RESPONSE_EVENT_ERROR:
      msg = new msg_response_event_error(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_REQUEST_EVENT:
      msg = new msg_request_event(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_EVENT:
      msg = new msg_event(sysId, componentId);
      msg.decode(dis);
      break;
