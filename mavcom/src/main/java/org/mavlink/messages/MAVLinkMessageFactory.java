...
import org.mavlink.messages.lquac.msg_param_v3_value;
...
import org.mavlink.messages.lquac.msg_param_start_transaction;
...
import org.mavlink.messages.lquac.msg_param_v3_ack;
...
import org.mavlink.messages.lquac.msg_param_v3_set;
...
import org.mavlink.messages.lquac.msg_param_commit_transaction;
...
public static MAVLinkMessage getMessage(int msgid, int sysId, int componentId, byte[] rawData) throws IOException {
  ...
  case MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE:
      msg = new msg_gimbal_device_set_attitude(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GIMBAL_MANAGER_STATUS:
      msg = new msg_gimbal_manager_status(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_CAMERA_FOV_STATUS:
      msg = new msg_camera_fov_status(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GIMBAL_MANAGER_INFORMATION:
      msg = new msg_gimbal_manager_information(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE:
      msg = new msg_gimbal_manager_set_attitude(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_MISSION_COUNT:
      ...
      msg.decode(dis);
      break;
  case MAVLINK_MSG_ID_PARAM_V3_VALUE:
      msg = new msg_param_v3_value(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_ESC_INFO:
      msg = new msg_esc_info(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_COMMAND_CANCEL:
      msg = new msg_command_cancel(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE:
      msg = new msg_autopilot_state_for_gimbal_device(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_SIM_STATE:
      ...
      msg.decode(dis);
      break;
  case MAVLINK_MSG_ID_PARAM_START_TRANSACTION:
      msg = new msg_param_start_transaction(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE:
      ...
      msg.decode(dis);
      break;
  case MAVLINK_MSG_ID_PARAM_V3_ACK:
      msg = new msg_param_v3_ack(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION:
      msg = new msg_gimbal_device_information(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_PARAM_SET:
      ...
      msg.decode(dis);
      break;
  case MAVLINK_MSG_ID_PARAM_V3_SET:
      msg = new msg_param_v3_set(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_CELLULAR_CONFIG:
      msg = new msg_cellular_config(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS:
      msg = new msg_gimbal_device_attitude_status(sysId, componentId);
      msg.decode(dis);
      break;
  ...
  case MAVLINK_MSG_ID_GPS_INPUT:
      ...
      msg.decode(dis);
      break;
  case MAVLINK_MSG_ID_PARAM_COMMIT_TRANSACTION:
      msg = new msg_param_commit_transaction(sysId, componentId);
      msg.decode(dis);
      break;
