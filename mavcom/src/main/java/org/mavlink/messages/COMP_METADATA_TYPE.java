...
/**
 * Interface COMP_METADATA_TYPE Supported component metadata types. These are
 * used in the "general" metadata file returned by COMPONENT_INFORMATION to
 * provide information about supported metadata types. The types are not used
...
public interface COMP_METADATA_TYPE {
	 ...
	 * information about other COMP_METADATA_TYPEs supported by the component. This
	 * type must be supported and must be downloadable from vehicle.
	 */
